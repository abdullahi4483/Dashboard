    ...
    var a = (function () {
      function t(e, n) {
        !(function (t, e) {
          ...
          (this.dataTable = new KTDataTable(e, this.dataTableOptions)),
      ...
      return (
        ...
        (a = [
                ...
                columns: {
                  select: {
                    render: function (t, e, n) {
                      ...
                      return (
                        (a.className = "kt-checkbox kt-checkbox-sm"),
                        (a.type = "checkbox"),
                        (a.value = e.id.toString()),
                        a.setAttribute("data-kt-datatable-row-check", "true"),
                        a.outerHTML.trim()
                      );
                    },
                  },
                  user: {
                    ...
                    render: function (e) {
                      var n = t.isLocalhost()
                        ...
                        : "metronic/tailwind";
                      return '\n              <div class="flex items-center gap-2.5">\n                <div class="shrink-0">\n                  <img class="h-9 rounded-full" src="/static/'
                        .concat(n, "/dist/assets/media/avatars/")
                        .concat(
                          e.avatar,
                  ...
                  location: {
                    ...
                    render: function (e) {
                      var n = t.isLocalhost()
                        ? "metronic-tailwind-html"
                        : "metronic/tailwind";
                      return '\n              <div class="flex items-center gap-1.5">\n                <img alt="flag" class="h-4 rounded-full" src="/static/'
                        .concat(n, "/dist/assets/media/flags/")
                        .concat(
                          e.flag,
                  ...
                  action: {
                    ...
                    createdCell: function (t, e, n) {
                      t.querySelector(".kt-btn").addEventListener(
                        ...
                        function () {
                          alert(
                            "Clicked on action button for row ".concat(
                              n.user.name
                            )
                          );
                        }
            ...
            value: function () {
              ...
              return new Map(
                Array.from(t).map(function (t) {
                  return [t.getAttribute("data-datatable-filter-column"), t];
                })
              );
            },
          },
          {
            ...
            value: function () {
              var t = this;
              this.dataTable.getState().filters.forEach(function (e) {
                var n = e.column,
                  a = e.value;
                if (t.filterMap.has(n)) {
                  var r = t.filterMap.get(n);
                  null !== r && (r.value = a || "");
                }
              }),
                this.filterMap.forEach(function (e, n) {
          ...
          },
          {
            ...
            value: function () {
              var t = this,
                e = document.querySelector('[data-datatable-search="true"]');
              if (this.dataTable && e) {
                var n = this.debounce(function () {
                  t.dataTable.search(e.value);
                }, 300);
          ...
          },
          {
            ...
            value: function () {
              var e = t.isLocalhost()
                ...
                n = new t(document.querySelector("#current_sessions_table"), e);
              n.initializeFilters(), n.initSearch();
            },
          },
        ]),
        a && e(n.prototype, a),
