        ...
        (r = [
          {
            ...
            value: function () {
              ...
              if (KTDom.getElement("#".concat(t)) && L) {
                var e,
                  o = L.map(t, { center: [40.725, -73.985], zoom: 30 });
                L.tileLayer(
            ...
            value: function () {
              var t = [
                ...
                e = {
                  ...
                  fill: { colors: t },
                  chart: { type: "donut" },
                  stroke: { show: !0, width: 2, colors: "var(--color-border)" },
                ...
                o = document.querySelector("#contributions_chart");
              ...
              var t = [
                ...
                e = {
                  ...
                  xaxis: {
                    ...
                    axisTicks: { show: !1 },
                    labels: {
                      style: { colors: "var(--color-white)", fontSize: "12px" },
                    },
                    crosshairs: {
                      position: "front",
                      stroke: {
                ...
                o = document.querySelector("#media_uploads_chart");
              o && new ApexCharts(o, e).render();
            },
          },
          {
                  ...
                  series: [
                    {
                      name: "series1",
                      data: [
                        70, 60, 75, 55, 35, 80, 100, 70, 90, 65, 50, 85, 60, 75,
                        65, 80,
                      ],
                    },
                  ],
                  chart: { height: 200, type: "area", toolbar: { show: !1 } },
                  dataLabels: { enabled: !1 },
                  legend: { show: !1 },
                  stroke: {
                    curve: "smooth",
